...
angular.module("mdColorPicker").run(["$templateCache", function($templateCache) {$templateCache.put("mdColorPicker.tpl.html","<md-icon md-svg-icon=\"{{icon}}\" ng-click=\"showColorPicker($event)\" ng-style=\"{color : value}\"\">\n	\n</md-icon>");
